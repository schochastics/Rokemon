...
An R package to create Pokemon style ggplots. It also includes a dataset of 801 Pokemon
with 41 features.
...
all 801 pokemon sprites. So far, I did not check all palettes, so there may well be
