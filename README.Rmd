...
all 801 pokemon sprites. I so far did not check all palettes, so there may well be
some weird ones. A better alternative would be to use the dedicated package `palettetown`.
...
* Sprites used for color palettes downloaded [here](https://github.com/PokeAPI/sprites)
